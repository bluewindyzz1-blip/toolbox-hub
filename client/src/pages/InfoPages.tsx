...
function GuideHub() {
  ...
  return <div className="site-page"><SeoHead title="계산 결과 활용 가이드 | 도구상자" description="대출, 부동산, 급여, 세금과 PDF 도구의 계산 결과를 확인하고 다음 행동으로 연결하는 실용 가이드입니다." path="/guides" kind="CollectionPage" /><SiteHeader /><main className="container guide-hub">
