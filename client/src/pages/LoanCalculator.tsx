...
export default function LoanCalculator() {
  ...
  return (
    <ToolMetaResolver slug="loan-interest">{(tool) => <ToolFrame index="04" tag="LOAN CALCULATOR" title="대출 이자 계산기" description="원리금균등·원금균등 상환 방식별 월 상환액, 전체 이자와 월별 상환표를 비교하세요.">
      ...
      <ToolKnowledge tool={tool} method="입력한 원금, 연 이자율, 기간을 월 단위로 환산한 뒤 원리금균등 또는 원금균등 방식에 따라 월 상환액과 이자를 계산합니다." example="3억원을 연 4.2%, 3년 원리금균등으로 입력하면 첫 달 상환액, 전체 이자와 월별 상환표를 확인할 수 있습니다." caution="실제 대출의 금리, 중도상환수수료, 거치기간, 일할 계산과 우대 조건은 금융기관의 계약 내용을 확인하세요." />
